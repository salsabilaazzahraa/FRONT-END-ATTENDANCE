...
class DinasScreen extends StatelessWidget {
  final TextEditingController _tanggalDinasController = TextEditingController();
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            _buildFormField("Tanggal dinas", context, _tanggalDinasController),
            SizedBox(height: 16),
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => RiwayatScreen(
                        tanggal: _tanggalDinasController.text,
                        sampaiTanggal: _sampaiTanggalController.text,
                        deskripsi: _deskripsiController.text,
                        icon: Icons.work_history_outlined, // Ikon untuk dinas
                      ),
                    ),
                  );
                },
